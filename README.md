...
LPDMvvmRouterKit is available through [CocoaPods](http://cocoapods.org). To install it, simply add the following line to your Podfile:
...
In the corresponding viewModel to implement the corresponding test: method, you can get in the method to receive this notification information. The arguments following the method must be the type of `id <LPDEventProtocol>`.
