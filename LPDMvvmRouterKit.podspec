...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/foxsofter/LPDMvvmRouterKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'foxsofter' => 'foxsofter@gmail.com' }
  s.source           = { :git => 'https://github.com/foxsofter/LPDMvvmRouterKit.git', :tag => s.version.to_s }
  ...
  # s.public_header_files = 'Pod/Classes/**/*.h'
    s.private_header_files = 'Pod/Classes/**/NSObject+LPDPerformAction.h', 'Pod/Classes/**/UIViewController+LPDFinder.h'
